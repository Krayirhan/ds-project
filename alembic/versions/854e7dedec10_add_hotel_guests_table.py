...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "deposit_type", sa.String(30), nullable=False, server_default="No Deposit"
        ),
        sa.Column(
            "market_segment", sa.String(30), nullable=False, server_default="Online TA"
        ),
        ...
        sa.Column(
            "stays_in_week_nights", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column(
            "stays_in_weekend_nights", sa.Integer(), nullable=False, server_default="1"
        ),
        sa.Column(
            "is_repeated_guest", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column(
            "previous_cancellations", sa.Integer(), nullable=False, server_default="0"
        ),
